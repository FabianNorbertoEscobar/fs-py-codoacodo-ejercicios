...
import aritmetica
'''
    Este ejemplo permite ingresar números enteros hasta que se ingresa el valor 0.
    Ademas informa cantidad de números pares ingresados y cantidad de números
    de dos cifras se ingresaron.
'''
cant_pares = 0
cant_nros_dos_dig = 0
