'''
Ejercicio Integrador: Implementar una clase llamada Empleado, que posee un atributo de clase (nro_empleados) que lleva la cuenta de los objetos instanciados.
...
class Empleado: #Creamos la clase
    ...
    def __init__(self, legajo, nombreCompleto, sueldo):
        ...
        self.sueldo = sueldo
        Empleado.nro_empleados += 1 # Empleado.nro_empleados = Empleado.nro_empleados + 1
    ...
    def titulos():
        print(f'Legajo\tNombre completo\tSueldo\tCategoría')
...
emp2 = Empleado("P1001", "Ana Quiroz", 250000)
emp3 = Empleado("C1002", "Luciano García", 80000)
emp4 = Empleado("H1003", "Marcela Priore", 175000)
