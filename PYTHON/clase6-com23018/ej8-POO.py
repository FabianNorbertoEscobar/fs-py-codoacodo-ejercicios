...
class Carrera:
    ...
    def agregar(self, mat): #mat: objeto de la clase Materia
        self.materias.append(mat) #Agregamos una materia a la lista de materias
...
carrera1.agregar(Materia("A1001", "Objetos I", 8))
carrera1.agregar(Materia("A1002", "Inteligencia Artificial", 6))
carrera1.agregar(Materia("A1002", "Python I", 4))
