...
if sueldo>3000: #Preguntamos si el sueldo es mayor a 3000
...
'''
Realizar un programa que solicite ingresar dos números distintos y muestre
por pantalla el mayor de ellos. Si NO son distintos mostrar un mensaje de error.
'''
num1=int(input("Ingrese el primer valor:"))
num2=int(input("Ingrese el segundo valor:"))
if num1!=num2: 
...
promedio e imprima alguno de estos mensajes:
    ...
    Si el promedio es entre 3 y 4: "Recupera".
    Para el resto de los casos mostrar "Reprobado".    
'''
